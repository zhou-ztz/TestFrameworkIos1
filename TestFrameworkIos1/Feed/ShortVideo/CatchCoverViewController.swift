...
class CatchCoverViewController: TSViewController {
    ...
    @IBAction func fininshBtnAction(_ sender: Any) {
        ...
        exportSession.exportAsynchronously { [weak self] in
            ...
            if let error = exportSession.error {
                UIAlertView(title: "error_saving".localized, message: error.localizedDescription, delegate: nil, cancelButtonTitle: "get_it".localized).show()
                self.finishBtn.isEnabled = false
                self.backBtn.isEnabled = false
            } else {
