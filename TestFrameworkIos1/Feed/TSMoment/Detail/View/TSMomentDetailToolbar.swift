...
////        super.init(frame: CGRect(x: 0, y: UIScreen.main.bounds.height - 48, width: UIScreen.main.bounds.width, height: 48), type: .top, items: [TSToolbarItemModel(image: "", title: "喜欢", index: 0), TSToolbarItemModel(image: "IMG_home_ico_comment_normal", title: "评论", index: 1), TSToolbarItemModel(image: "IMG_detail_ico_share_normal", title: "分享", index: 2), TSToolbarItemModel(image: "", title: "collect".localized, index: 3)])
...
//        }
//    super.init(frame: CGRect(x: 0, y: yPoint, width: UIScreen.main.bounds.width, height: 48 + TSBottomSafeAreaHeight), type: .top, items: [TSToolbarItemModel(image: "", title: "text_like".localized, index: 0), TSToolbarItemModel(image: "IMG_home_ico_comment_normal", title: "text_comment".localized, index: 1), TSToolbarItemModel(image: "IMG_detail_ico_share_normal", title: "choice_share".localized, index: 2), TSToolbarItemModel(image: "IMG_home_ico_more", title: "text_more".localized, index: 3)])
//    }
//
...
//            // 更改动态数据库
//            DatabaseManager().moment.change(digg: object)
//        }
        // [长期注释] 动态详情页收藏按钮改为“更多”按钮. 2017/04/24
//        if index == 3 { // 收藏
