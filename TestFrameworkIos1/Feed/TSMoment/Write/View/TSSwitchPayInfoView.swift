...
//            make.height.equalTo(switchContentView.snp.height)
    ...
    private func createUI() {
        ...
        switchInfoLabel.text = "dynamic_send_toll".localized
        ...
        settingInfoLabel.text = "dynamic_send_toll_words_count".localized
        ...
        promptLeftInfoLabel.text = "reward_custom_amount".localized
        ...
        priceTextField.placeholder = "placeholder_enter_amount".localized
        ...
        remarkLabel.text = "warning_exceed".localized + "\(TSAppConfig.share.localInfo.feedLimit)" + "exceed_word_limit_need_pay".localized
