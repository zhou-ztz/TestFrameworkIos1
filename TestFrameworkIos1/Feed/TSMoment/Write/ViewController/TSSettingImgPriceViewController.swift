...
class TSSettimgPriceViewController: TSViewController, UITextFieldDelegate, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.title = "dynamic_send_toll_title".localized
    ...
    func setPriceCharges() {
        ...
        setTip(theTip: tiplabel, theSuperview: thePriceChargesBackgroundview, theWidth: 105, theTipSting: "dynamic_send_toll_way".localized)
        ...
        setButton(giveButton: toSee, givePricetag: 501, givePricetxt: "dynamic_send_toll_look".localized)
        setButton(giveButton: toDownload, givePricetag: 502, givePricetxt: "dynamic_send_toll_download".localized)
    ...
    func setPrice() {
        ...
        let tiplabel = UILabel()
        setTip(theTip: tiplabel, theSuperview: thePriceBackgroundview, theWidth: 105, theTipSting: "dynamic_send_toll_count".localized)
    ...
    private func setButtons() {
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(image: UIImage.set_image(named: "iconsArrowCaretleftBlack"), style: .plain, target: self, action: #selector(tapCancelButton))
    ...
    func setUserPrice() {
        ...
        userPricelable.text = "reward_custom_amount".localized
        ...
        userPriceNumber.placeholder = "placeholder_enter_amount".localized
        ...
        submitButtion.setTitle("confirm".localized, for: .normal)
