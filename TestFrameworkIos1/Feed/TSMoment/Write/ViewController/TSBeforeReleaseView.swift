...
class TSBeforeReleaseView: UIView, UIGestureRecognizerDelegate {
    ...
    /// 退出图标
    var exitImage: UIImageView = UIImageView(image: UIImage.set_image(named: "IMG_common_ico_close"))
    /// Logo图片
    var logoImage: UIImageView = UIImageView(image: UIImage.set_image(named: "logo_thinksns+"))
    /// 页面高度
