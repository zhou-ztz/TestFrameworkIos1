...
class TSTopicGroupVCViewController: TSViewController, UIScrollViewDelegate {
    ...
    func setUI() {
        ...
        hotButton.setTitle("topics_hot".localized, for: .normal)
        hotButton.tag = 666
        ...
        newButton.setTitle("topics_latest".localized, for: .normal)
        newButton.tag = 999
    ...
    @objc func searchButtonTaped() {
        ...
        let nav = TSNavigationController(rootViewController: searchVC)
