...
class TopicSearchVC: TSViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    /// 搜索框
    ...
    var onSelectTopic: ((TopicListModel) -> Void)?
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        if keyword == "" {
            ...
            sectionTitleL.text = "recomment_topic".localized
