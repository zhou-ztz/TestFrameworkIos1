...
class TSAMapLocationView: UIView {//, AMapLocationManagerDelegate {
    ...
    /// 定位完成图标
    let locationImage: UIImageView = UIImageView(image: UIImage.set_image(named: "IMG_find_ico_location2"))
    /// 三方定位控制器
//    lazy var locationManager = AMapLocationManager()
    ...
    func setUI() {
        ...
        locationTitleLabel.text =  "current_location".localized
        ...
        locationLabel.text =  "unlocation".localized
...
//            }
//        }
//        self.locationLabel.text = locationArray.last ??  "text_failed_to_retrieve_location".localized
...
//            TSErrorTipActionsheetView().setWith(title: "location_permission".localized, TitleContent: String(format: "location_permission_tip".localized, "\(appName)", "\(appName)"), doneButtonTitle: ["setting_permission".localized, "cancel".localized], complete: { (_) in
...
//                    self?.locationLabel.text = "error_location_locate_fail".localized
...
//                    self?.locationLabel.text = "error_location_other".localized
//                    self?.finishBlock?(nil)
//                    self?.showImageOrAnmie(show: .Iamge)
//                }
//            }
