...
//                        TSUtil.dismissPwdVC()
//                    } else {
//                        NotificationCenter.default.post(name: NSNotification.Name.Pay.showMessage, object: nil, userInfo: ["message": message ?? "tips_verify_fail".localized])
//                        return
//                    }
//                }
//                // 成功加入
...
//                } else {
//                    // 加入失败
//                    let faildAlert = TSIndicatorWindowTop(state: .faild, title: message ?? "group_join_fail".localized)
...
//        // 1.显示加载中弹窗
//        let indicator = TSIndicatorWindowTop(state: .loading, title: "text_paying".localized)
//        indicator.show()
//        // 2.发起网络请求
...
//                if TSAppConfig.share.localInfo.shouldShowRewardAlert && isSuccess == false {
...
//                }
//            }
//            if TSAppConfig.share.localInfo.shouldShowRewardAlert && isSuccess {
//                TSUtil.dismissPwdVC()
//            }
//
...
//        var description = "tips_only_need_pay".localized + price.tostring(decimal: 0) + TSAppConfig.share.localInfo.goldName
//        switch type {
//        case .text:
//            description += "tips_pay_to_see_content".localized
//        case .pictureSee:
//            description += "tips_pay_to_see_picture".localized
//        case .pictureDownload:
//            description += "tips_pay_to_download_picture".localized
//        case .joinGroup:
//            description += "tips_join_circle".localized
//        }
//        // 设置显示内容
//        labelForTitle.text = "tips_purchase_payment".localized
