...
@objc protocol FilterSectionViewType {
    var model: FilterSectionViewModel { get set }
}
...
class FilterSectionView: UITableViewHeaderFooterView, FilterSectionViewType {
    ...
    func loadFilterButton() {
        ...
        filterButton.setImage(UIImage.set_image(named: "IMG_ico_quora_question_sort"), for: .normal)
    ...
    func loadTopicButton() {
        ...
        if model.followStatus {
            ...
            topicFollowButton.setTitle("followed".localized, for: .normal)
            ...
            topicFollowButton.setTitle("add_follow".localized, for: .normal)
        }
...
class FilterSectionViewAlert: TSViewController {
...
class FilterAlertCell: UITableViewCell {
    ...
    func load(title: String, isSelected: Bool) {
        ...
        markImageViwe.image = UIImage.set_image(named: "IMG_ico_quora_question_select")
