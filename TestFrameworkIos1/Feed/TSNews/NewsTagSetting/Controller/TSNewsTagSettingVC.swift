...
class TSNewsTagSettingVC: TSViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func layouBaseUI() {
        ...
        self.closeButton?.frame = CGRect(x: ScreenSize.ScreenWidth - TSNewsTagSettingVCUX.buttonWidth - TSNewsTagSettingVCUX.collectionItemSpace - 15, y: 0, width: TSNewsTagSettingVCUX.buttonWidth, height: TSNewsTagSettingVCUX.buttonHeight)
        self.closeButton?.setTitle("collapse".localized, for: UIControl.State.normal)
        ...
        self.editableChangeButton?.setTitle("edit".localized, for: UIControl.State.normal)
        ...
        self.hintLable?.text = "events_long_press_edit".localized
...
// MARK: - UICollenctionViewDelegate
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        if indexPath.section == 0 {
            headerView.setTitle(text: "events_my_subscricption".localized)
        } else {
            headerView.setTitle(text: "events_more_subscription".localized)
        }
        return headerView
    }
...
//        }
    ...
    func setEditStyleUI() {
        ...
        if self.eidtEnable {
            self.hintLable?.text = "events_click_to_delete".localized
            self.editableChangeButton?.setTitle("complete".localized, for: UIControl.State.normal)
        } else {
            self.hintLable?.text = "events_long_press_edit".localized
            self.editableChangeButton?.setTitle("edit".localized, for: UIControl.State.normal)
        }
