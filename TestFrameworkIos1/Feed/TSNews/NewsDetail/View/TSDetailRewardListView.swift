...
class TSDetailRewardListView: UIView, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    var rewardModel: TSNewsRewardCountModel! {
        didSet {
            ...
            let countString = "\(rewardModel.count)" + "event_detail_reward".localized + "event_detail_total".localized + amountStr + TSAppConfig.share.localInfo.goldName
            ...
            let nsRange2Str = "event_detail_total".localized + amountStr
    ...
    override init(frame: CGRect) {
        ...
        let rewardUserListArrow = UIImageView(image: UIImage.set_image(named: "IMG_ic_arrow_smallgrey"))
        rewardUserListArrow.isHidden = true
