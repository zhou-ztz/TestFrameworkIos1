...
- (void)imagePickerController:(TZImagePickerController *)picker didFinishPickingVideo:(PHAsset *)asset;
...
- (void)imagePickerControllerDidClickRecordVideoBtn:(TZImagePickerController *)picker;
