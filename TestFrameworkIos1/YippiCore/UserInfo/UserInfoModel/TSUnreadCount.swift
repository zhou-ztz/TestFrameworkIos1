...
class TSUnreadCount: NSObject {
    ...
    var followedUsers: String? {
        set {
            UserDefaults.standard.set(newValue, forKey: "UnreadCountType.followedUsers")
            UserDefaults.standard.synchronize()
        }
        get {
            return UserDefaults.standard.string(forKey: "UnreadCountType.followedUsers")
        }
    }
    /// 被用户关注时间
    var followedUsersDate: Date? {
        set {
            UserDefaults.standard.set(newValue, forKey: "followedUsersDate")
            UserDefaults.standard.synchronize()
        }
        get {
            return UserDefaults.standard.value(forKey: "followedUsersDate") as? Date
        }
    }
    /// 消息未读数
    var imMessage: Int = 0
    ...
    var reject: Int {
        set {
            UserDefaults.standard.set(newValue, forKey: UnreadCountType.reject.rawValue)
            UserDefaults.standard.synchronize()
        }
        get {
            return UserDefaults.standard.integer(forKey: UnreadCountType.reject.rawValue)
        }
    }
    ...
    var dailyTreasure: Int {
        set {
            UserDefaults.standard.set(newValue, forKey: UnreadCountType.dailyTreasure.rawValue)
            UserDefaults.standard.synchronize()
        }
        get {
            return UserDefaults.standard.integer(forKey: UnreadCountType.dailyTreasure.rawValue)
        }
    }
    ...
    func allNoticeUnreadCount() -> Int {
        return follows + comments + like + pending + system + at + reject
    }
    
    func meSettingHasUnread() -> Bool {
        return (system + reject) > 0 || UserDefaults.standard.bool(forKey: "gamification_leveling_upgrade")
    }
}
