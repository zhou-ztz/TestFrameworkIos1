...
//        }
    ...
    private func initialUI() -> Void {
        ...
        // 2.x typeOptionView
        let titles = ["stick_type_group_commnet".localized,  "stick_type_news_commnet".localized, "pin_post_comment".localized,  "pin_post".localized]
        let buttonReceiveTypes = [ReceivePendingController.ShowType.momentCommentTop, ReceivePendingController.ShowType.newsCommentTop, ReceivePendingController.ShowType.postCommentTop, ReceivePendingController.ShowType.postTop]
        let pendingCounts = [TSCurrentUserInfo.share.unreadCount.feedCommentPinned, TSCurrentUserInfo.share.unreadCount.newsCommentPinned, TSCurrentUserInfo.share.unreadCount.postCommentPinned, TSCurrentUserInfo.share.unreadCount.postPinned]
