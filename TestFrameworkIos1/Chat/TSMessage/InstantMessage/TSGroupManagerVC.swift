...
class TSGroupManagerVC: TSViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        title = "chat_group_manager".localized
    ...
    func creatSubViews() {
        ...
        groupManagerLabel.text = "chat_edit_group_owner_manage".localized
        ...
        groupManagerIcon.image = UIImage.set_image(named: "IMG_ic_arrow_smallgrey")
