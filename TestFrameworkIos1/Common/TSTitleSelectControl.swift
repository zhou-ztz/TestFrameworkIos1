...
class TSTitleSelectControl: UIControl {
    ...
    /// 图标
    fileprivate let iconView = UIImageView(image: UIImage.set_image(named: "IMG_ico_detail_arrowdown"))
    fileprivate let icon = UIImage.set_image(named: "IMG_ico_detail_arrowdown")!
