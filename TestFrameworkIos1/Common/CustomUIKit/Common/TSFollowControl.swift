...
class TSFollowControl: UIControl {
    ...
    override var isSelected: Bool {
        didSet {
            self.titleLabel.text = isSelected ? "followed".localized : "display_follow".localized
            self.iconView.image = isSelected ? UIImage.set_image(named: "IMG_channel_ico_added") : UIImage.set_image(named: "IMG_channel_ico_add_blue")
    ...
    private func initialUI() -> Void {
        ...
        // 3. default
        titleLabel.text = "add_follow".localized
        iconView.image = UIImage.set_image(named: "IMG_channel_ico_add_blue")
    }
