...
class TSKBNewsInputAccessoryView: UIView {
    ...
    private func initialUI() -> Void {
        ...
        downBtn.setImage(UIImage.set_image(named: "IMG_sec_nav_arrow"), for: .normal)
        ...
        picBtn.setImage(UIImage.set_image(named: "IMG_icon_picture_grey"), for: .normal)
        picBtn.setImage(UIImage.set_image(named: "IMG_icon_picture_blue"), for: .selected)
