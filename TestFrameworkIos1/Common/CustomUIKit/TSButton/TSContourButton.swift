...
private struct TSContourButtonUX {
    ...
    static let BackgroundHighLightLightColor = ButtonColor().normal.withAlphaComponent(0.08)
    static let BorderHighLightLightColor = MainColor().theme

    static let TitleHighLightDarkColor = UIColor(hex: 0xffffff)
    static let BackgroundHighLightDarkColor = TSContourButtonUX.TitleHighLightDarkColor.withAlphaComponent(0.08)
