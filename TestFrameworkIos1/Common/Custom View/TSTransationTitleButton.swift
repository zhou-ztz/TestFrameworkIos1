...
class TSTransationTitleButton: TSButton {
    ...
    func setUI() {
        setImage(UIImage.set_image(named: "IMG_ico_detail_arrowup"), for: .selected)
        setImage(UIImage.set_image(named: "IMG_ico_detail_arrowdown"), for: .normal)
        setTitleColor(TSColor.main.content, for: .normal)
        setTitle("display_detail".localized, for: .normal)
    }
}
