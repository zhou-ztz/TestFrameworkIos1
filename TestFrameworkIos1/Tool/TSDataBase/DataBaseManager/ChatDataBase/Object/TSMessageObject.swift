...
class TSMessageObject: Object {
    ...
    @objc dynamic var fromUserID: Int = -1
    /// 接收到消息时,消息所属的会话的会话编号
    @objc dynamic var conversationID: Int = -1
    /// 消息内容
    @objc dynamic var messageContent: String? = nil
    /// 消息类型
    @objc dynamic var messageType: Int = -1
    /// 扩展内容
    ...
    @objc dynamic var responseTimeStamp: NSDate = NSDate()
    /// 主键
    /// 
