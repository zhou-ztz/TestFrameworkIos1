...
struct TSMomentToolModel {
    ...
    var isCollect: Int = 0
    /// 当前用户是否有打赏，0 为否，1 为是
    var isRewarded: Int = 0
    /// 当前用户是否有禁止留言，0 为否，1 为是
    var isCommentDisabled: Int = 0
...
extension TSMomentToolModel {
    init(_ json: [String: Any]) {
        ...
        self.isRewarded = jsonData["has_reward"]!.int!
        self.isCommentDisabled = jsonData["disable_comment"]!.int!
    }
}
