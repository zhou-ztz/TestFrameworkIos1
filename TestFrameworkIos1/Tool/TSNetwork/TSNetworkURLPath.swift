...
enum TSURLPathV2: String {
    ...
    enum User: String {
        ...
        /// 认证
        case certificateCheckId = "user/certification/checkID"
        /// 环信密码
        ...
        /// get address form inputs
        case residentialInput = "user/certification/residentialInput"
        /// update auto leveling upgrade flag
        case autoLevelingUpgradeDialogMessage = "user/certification/displayAutoUpgradeDialog"
        /// update auto leveling upgrade flag
        case updateAutoLevelingUpgradeFlag = "user/certification/closeAutoUpgradeDialog"
        /// user session duration
        case userSessionDuration = "user/session"
        /// user gamification leveling badge
        case gamificationUserLevelingInfo = "user/privileges/show"
        /// 获取所有国家列表
        case getAllCountry = "user/location"
        /// 获取州省列表
        case getProvince = "user/locationState"
        /// 获取城市列表
        case getCity = "user/locationCity"
        /// 获取填写个人资料所需数据 - relationship & language & work industry
        case getProfileInfoData = "user/fixedInfo"
        /// 获取所有的Tag（个人兴趣标签）
        case getTags = "tags"
        /// 首次设置用户兴趣标签（仅在注册时调用）
        case addTags = "user/tags/add"
        /// 修改用户兴趣标签
        case updateTags = "user/tags/update"
        /// 获取当前用户的兴趣标签
        case getUserTags = "user/tags"
        /// 修改用户infomation v6.21.0新增
        case updateUserInfo = "user/update-info"
        /// 修改用户一次性密码设定
        case updateUserOtpSettings = "users/otp/settings"
    }
    
    /// Sobot
    case sobotCategory = "sobot/list"
    ...
    enum System: String {
        ...
        case country = "personalisedcontent/setting/countries"
        
        case language = "personalisedcontent/setting/languages"
    }
    ...
    enum UploadFile: String {
        ...
        /// 文件上传和获取
        case files // Deprecated, use https://upload-cn.yiartkeji.com/api/v2/files instead
    }
    ...
    enum Notification: String {
        ...
        /// 当一个别名绑定了10个以上的设备, 清除所有绑定设备
        case flushAccounts = "engagelab/flush-accounts"
    }
    ...
    enum Message: String {
        ...
        /// translate
        case translateText = "translates/text"
    }
    /// 版本号
    ...
    /// 小程序
    enum MiniProgram: String {
        case getScope = "oauth"
        case getList = "mini-program"
    }
    
    /// Log
    enum Log: String {
        case requestLog = "log-files-request?channel=rewardsLink"
        case uploadLog = "log-files"
    }
}
