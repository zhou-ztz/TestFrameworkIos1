...
extension PhotosDataManager {
    ...
    internal class func convertToData(asset: PHAsset, disPlayWidth width: CGFloat, complete: @escaping(Data?) -> Void) {
           ...
           // 5.将 asset 装换成 data
        PHCachingImageManager.default().requestImageData(for: asset, options: imageOptions, resultHandler: {
            (data, _ , _ ,_ ) in
