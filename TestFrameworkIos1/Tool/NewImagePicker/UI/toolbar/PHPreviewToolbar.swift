...
class PHPreviewToolbar: UIView {
    ...
    func setUI() {
        ...
        buttonForChoose.setTitle( "select_text".localized, for: .normal)
        buttonForChoose.setImage(UIImage.set_image(named: img_selected), for: .selected)
        buttonForChoose.setImage(UIImage.set_image(named: img_unselect), for: .normal)
        // 初始化的时候就选中
