...
class AlbumCollectionVC: TSViewController, ImagePickerDataUsable {
    ...
    func setUI() {
        ...
        // 3.添加取消按钮
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "cancel".localized, style: .plain, target: self, action: #selector(cancelButtonTaped))
    }
