...
class ImageCropVC: TSViewController, UIScrollViewDelegate {
    ...
    func setUI() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "done".localized, style: .plain, target: self, action: #selector(cropImage))
