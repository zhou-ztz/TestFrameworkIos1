...
class CustomPHPreViewVC: TSViewController, TSSettingImgPriceVCDelegate {
    ...
    func setupNavRightBtn() {
        ...
        navRightBtn.setTitle("toll_setting".localized, for: .normal)
    ...
    func updateToolbar() {
        ...
        // 2.设置 完成按钮
        toolbar.buttonForFinish.setTitle(String(format: "photo_select_done".localized, selectedAssets.count, allAssets.count), for: .normal)
